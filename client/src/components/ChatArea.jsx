...
export default function ChatArea({ selectedDocuments = [], history, isSending, error, onSendMessage, onClearChat, onDownloadDocument, onToggleMobileSidebar }) {
  ...
  return (
    <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-3 sm:px-4 md:px-6 py-3 sm:py-4 flex flex-col gap-3 sm:gap-4">
      ...
      <div className="border-t border-gray-200 bg-white px-3 sm:px-4 md:px-6 py-3 sm:py-4 flex-shrink-0">
        ...
        <div className="flex items-end gap-2 sm:gap-3">
          <textarea
            ...
            placeholder={hasDocuments ? `Ask a question about your document${selectedDocuments.length > 1 ? 's' : ''}...` : "Select documents first"}
            rows={1}
